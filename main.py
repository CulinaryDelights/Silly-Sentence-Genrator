...
nouns = ["pizza", "tin can", "shark", "headphone", "light", "video game", "cousin", "waffle", "monster", "ukulele",
         ...
         "banjo", "rodent", "gamma ray", "suitcase", "jacket", "decapitated head", "flugal horn", "painting",
...
sentence_ends = [f"a {RandomList(adjectives)} {RandomList(nouns)} was {TenseIt(RandomList(verbs),'ing')}.",
                 f"I {RandomList(verbs)} all the time, almost constantly!",
                 f"my {RandomList(adjectives)} {RandomList(nouns)}s favorite thing to do was {TenseIt(RandomList(verbs),'ing')}.",
                 f"a {RandomList(adjectives)} {RandomList(nouns)} was {RandomList(adjectives)}.",
                 f"I met {RandomList(noun_people)}.",
                 f"everyone in {RandomList(noun_places)} was {TenseIt(RandomList(verbs),'ing')}.",
                 ...
                 f"{TenseIt(RandomList(verbs),'ing')} reminded me of {RandomList(nouns)}.",
